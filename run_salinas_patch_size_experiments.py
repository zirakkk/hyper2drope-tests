#!/usr/bin/env python3
"""
Patch Size Sensitivity Analysis for Salinas Dataset
...
def update_patch_size(config_path, patch_size):
    """Update patch size for Salinas dataset in config file"""
    print(f"Updating patch size to {patch_size} in {config_path}")
    
    config_data = load_config(config_path)
    config_data['datasets']['Salinas']['patch_size'] = patch_size
    save_config(config_path, config_data)
    
    print(f"Updated Salinas patch_size to: {patch_size}")
...
def run_experiment(patch_size):
    ...
    current_patch_size = config_data['datasets']['Salinas']['patch_size']
...
def main():
    ...
    print("Starting patch size sensitivity analysis for Salinas dataset...")
